...
// Route — развилка по первому сегменту пути: имя зарегистрированной локации
// уводит запрос к ней, всё прочее уходит в fallback (у двери это названный
// отказ — смотреть за ней нечего, см. noFace в cmd/world).
//
// Реестр спрашивают первым, и это правило, а не удобство: маршрут выводится из
// РЕГИСТРАЦИИ, и никакой другой источник имён его не перебивает.
