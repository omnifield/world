 ...
 * `submit`, и кнопка «Скоупа ещё нет — завести по адресу» отправляла бы форму входа вместо
 * того, чтобы открыть форму заведения. Отправляет та кнопка, которой сказали `type="submit"`.
 */
