...
//
// Ввод — это событие `input` на живом элементе, а не присвоение сигналу: поле управляемое,
// значение в него возвращается через `onChange` (`src/ui.tsx`), и проба обязана ходить тем же
