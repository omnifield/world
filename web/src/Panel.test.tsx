...
describe("первый вход в мир — свежесозданный скоуп", () => {
  ...
  it("вышел, вошёл другой личностью — видны ЕЁ территории, а не чужие", async () => {
    ...
    // Тела здесь настоящие — их разбирает `liveControl`, а не подставленный контроллер.
    // Поэтому и поля новые: комьюнити и заявленный ресурс контроллер пишет ВСЕГДА
    // (`WORLD2-122`), и ответ без них разбор отвергнет — как и всякую разъехавшуюся форму.
    const участокТеста = {
      name: "проба",
      addr: "world@10.8.0.9",
      reach: "отвечает",
